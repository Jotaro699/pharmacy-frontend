...
const Display = () => {
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      // Check if the pressed key is "ArrowLeft"
      if (e.key === "ArrowLeft") {
        window.location.href = "http://localhost:3000/produits"; // ✅ bdla path ila bghiti
      }
    };
...
//   useEffect(() => {
//     const timer = setInterval(() => {
//       if (mode === "slideshow" && items.length > 0) {
...
//       {/* Slideshow */}
//       {mode === "slideshow" && (
//         <div className="relative w-full h-screen pt-24 pb-20">
...
//                         <Tag size={14} />-{item.promotion_percentage}%
//                       </div>
//                     )}
//                   <h1 className="text-2xl font-bold flex items-center gap-3 text-emerald-900">
//                     <div className="w-8 h-8 bg-gradient-to-br from-emerald-500 to-green-500 rounded-full flex items-center justify-center shadow-inner">
...
//                               {(
//                                 item.price /
//                                 (1 - item.promotion_percentage / 100)
//                               ).toFixed(2)}{" "}
//                               DH
//                             </span>
//                           )}
